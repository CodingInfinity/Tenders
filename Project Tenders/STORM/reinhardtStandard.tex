...
\cventry{2014-2016}{BSc Computer Science (Still in final year of Degree)}{University iof Pretoria}{Tepatitlán}{Majoring in Computer Science}{}{}
...
This project would greatly simplify the lives of the COS 301 Lecturers, but the application of this project is much wider.
Any group based activity where people are grouped into teams can use this software to shuffle the teams in certain ways.
This would then free up the facilitators to use their time to actually edit the parameters of the program more intellegently,
instead of wasting time manually pairing up teams. This project is both useful in the real world and challenging.
